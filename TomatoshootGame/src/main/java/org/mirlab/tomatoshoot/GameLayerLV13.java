...
public class GameLayerLV13 extends GameLayerBase
{
	...
	Scripts[][] scriptListsB= {
			// step-type
			{Scripts.RIGHT,Scripts.RIGHT,Scripts.UP,Scripts.UP,Scripts.RIGHT,Scripts.RIGHT,Scripts.UP,Scripts.UP,
				Scripts.RIGHT,Scripts.RIGHT,Scripts.UP,Scripts.UP,Scripts.RIGHT,Scripts.RIGHT},
			// step-type 90 orientation 
			{Scripts.RIGHT,Scripts.RIGHT,Scripts.DOWN,Scripts.DOWN,Scripts.RIGHT,Scripts.RIGHT,Scripts.DOWN,Scripts.DOWN,
				Scripts.RIGHT,Scripts.RIGHT,Scripts.DOWN,Scripts.DOWN,Scripts.RIGHT,Scripts.RIGHT},
	};
	...
	public static CCScene scene()
	{
		scene = CCScene.node();
		scene.setTag(2);
		CCColorLayer layer = new GameLayerLV13(ccColor4B.ccc4(0, 0, 0, 0));
		//scene.setVisible(false);
		scene.addChild(layer);
		
		return scene;
	}
	protected GameLayerLV13(ccColor4B color)
	{
		super(color);		
	...
	public void initContents()
	{
		...
		addBugs(EnemyTypes.BUGA, PathTypes.A, finalHP_A,2,3);
		addBugs(EnemyTypes.BUGA, PathTypes.A, finalHP_A,2,3);

		
		addBugs(EnemyTypes.BUGC, PathTypes.B, finalHP_B,5,2);
		addBugs(EnemyTypes.BUGC, PathTypes.B, finalHP_B,1,2);
