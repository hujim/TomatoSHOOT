...
public class EnemyBug extends RealWorldObject {
	...
	public enum EnemyTypes{
		NULL, BULLEYE, BADTOMATO, BOTTLEA, BOTTLEB, BUGA, BUGB, BUGC, BOSSA, BOSSB,
		STRAW, TOMATOORZ, BALLOON, TOMATOHOSTAGE, PLUMA, PLUMB
	}
	...
	public void update()
	{
		...
		circleProgress.setPercentage(100f*(health_points/MAXHEALTH));
