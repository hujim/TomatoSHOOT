...
public class GameLayerLV12 extends GameLayerBase
{
	...
	public static CCScene scene()
	{
		scene = CCScene.node();
		scene.setTag(2);
		CCColorLayer layer = new GameLayerLV12(ccColor4B.ccc4(0, 0, 0, 0));
		//scene.setVisible(false);
		scene.addChild(layer);
		
		return scene;
	}
	protected GameLayerLV12(ccColor4B color)
	{
		super(color);		
	...
	public void initContents()
	{
		...
		addBugs(EnemyTypes.BUGB, PathTypes.A, finalHP_A,1,2);
		addBugs(EnemyTypes.BUGB, PathTypes.A, finalHP_A,1,2);
		addBugs(EnemyTypes.BUGB, PathTypes.A, finalHP_A,1,2);
		addBugs(EnemyTypes.BUGB, PathTypes.A, finalHP_A,1,2);
		addBugs(EnemyTypes.BUGB, PathTypes.A, finalHP_A,1,2);
		...
		addBugs(EnemyTypes.TOMATOHOSTAGE, PathTypes.B, finalHP_B,0,3);
		addBugs(EnemyTypes.TOMATOHOSTAGE, PathTypes.B, finalHP_B,0,3);
		addBugs(EnemyTypes.TOMATOHOSTAGE, PathTypes.B, finalHP_B,0,3);
		addBugs(EnemyTypes.TOMATOHOSTAGE, PathTypes.B, finalHP_B,0,3);
		addBugs(EnemyTypes.TOMATOHOSTAGE, PathTypes.B, finalHP_B,0,3);
	...
	protected void addBugs(EnemyTypes etype, PathTypes ptype, float eHP, int ezSPD, int exySPD)
	{
		...
		if (etype==EnemyTypes.BUGB)
			...
			target.bugSprite = CCSprite.sprite(CCSpriteFrameCache.sharedSpriteFrameCache().spriteFrameByName("TOMATOHOSTAGE.png"));
