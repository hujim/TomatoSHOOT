...
public class GameLayerLV06 extends GameLayerBase
{
	...
	public static CCScene scene()
	{
		scene = CCScene.node();
		scene.setTag(2);
		CCColorLayer layer = new GameLayerLV06(ccColor4B.ccc4(0, 0, 0, 0));
		//scene.setVisible(false);
		scene.addChild(layer);
		
		return scene;
	}
	protected GameLayerLV06(ccColor4B color)
	{
		super(color);		
	...
	public void initContents()
	{
		...
		addBugs(EnemyTypes.BOSSA, PathTypes.B, finalHP_A,1,3);
		
		
		addBugs(EnemyTypes.BUGA, PathTypes.A, finalHP_B,1,2);
		addBugs(EnemyTypes.BUGA, PathTypes.A, finalHP_B,1,2);
		addBugs(EnemyTypes.BUGA, PathTypes.A, finalHP_B,1,2);
		addBugs(EnemyTypes.BUGA, PathTypes.A, finalHP_B,1,2);
		addBugs(EnemyTypes.BUGA, PathTypes.A, finalHP_B,1,2);
